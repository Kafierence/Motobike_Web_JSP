					...
					<div class="carousel-inner bg-light">
						<div class="carousel-item active">
							<img class="w-100 h-400"
								src="/MotorbikeStore/uploads/images/product/${model3.picName}" alt="Image" style=" height: 600px" >
						</div>
						<c:forEach var="item" items="${model2.listResult}">
							<c:set var="path" value="/MotorbikeStore/uploads/images/product/${item.picName}" />
							<div class="carousel-item">
							<img class="w-100 h-400"
								src="${path}" alt="Image" style=" height: 600px">
							</div>
						</c:forEach>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="media mb-4">
										<img src="template/web/homepage/img/user.jpg" alt="Image"
			...
			<div class="col">
				<div class="owl-carousel related-carousel">
					<div class="product-item bg-light">
						<div class="product-img position-relative overflow-hidden">
							<img class="img-fluid w-100"
								src="template/web/homepage/img/sirius.jpg" alt="">
					...
					<div class="product-item bg-light">
						<div class="product-img position-relative overflow-hidden">
							<img class="img-fluid w-100"
								src="template/web/homepage/img/shmode.jpg" alt="">
							<div class="product-action">
								<a class="btn btn-outline-dark btn-square" href=""><i
									class="fa fa-shopping-cart"></i></a> <a
									class="btn btn-outline-dark btn-square" href=""><i
